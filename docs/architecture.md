...
- Deezer metadata quality varies; it is treated as optional enrichment rather than a prerequisite for release sync.
- Last.fm import is still best-effort and currently enriches canonical artists with provider mappings opportunistically.
